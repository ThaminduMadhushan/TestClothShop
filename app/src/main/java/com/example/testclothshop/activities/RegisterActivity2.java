                ...
                .addOnCompleteListener(RegisterActivity2.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(RegisterActivity2.this, "Successfully Register", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(RegisterActivity2.this, MainActivity.class));
                        }else {
                            Toast.makeText(RegisterActivity2.this, "Registration Failed"+task.getException(), Toast.LENGTH_SHORT).show();
